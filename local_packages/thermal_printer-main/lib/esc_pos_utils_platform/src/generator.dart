...
class Generator {
  ...
  List<List<int>> _toColumnFormat(img.Image imgSrc, int lineHeight) {
    ...
    img.fill(biggerImage, img.Color.fromRgb(255, 255, 255));
    ...
    while (left < widthPx) {
      ...
      final img.Image slice =
          img.copyCrop(biggerImage, left, 0, lineHeight, heightPx);
  ...
  List<int> textLeftRight(String leftText, String rightText,
      {bool containsChinese = false}) {
    /// Portuguese
