...
class _AssetsScannerOptions {
  ...
  String get outFileName =>
      fileName.toLowerCase().endsWith('.dart') ? fileName : '$fileName.dart';
  ...
  factory _AssetsScannerOptions.fromYamlMap(YamlMap map) {
    return _AssetsScannerOptions._(
      ...
      className: map['className'] as String? ?? 'Assets',
      fileName: map['fileName'] as String? ?? 'assets',
...
class AssetsBuilder extends Builder {
  ...
  FutureOr<void> build(BuildStep buildStep) async {
    ...
    final output =
        AssetId(buildStep.inputId.package, p.join(dir, options.outFileName));
      ...
      for (final assetPath in assetPaths) {
        ...
        if (propertyName.isNotEmpty) {
          ...
          assetPathsClass
            ...
            ..writeln('/// `$assetPath`')
            ..writeln(
                '  static const ${_validName(propertyName)} = \'$assetPath\';')
            ..writeln();
        }
      }
  ...
  String _validName(String val) {
    var i = 0;
    var outName = '';
    for (var x in val.split('_')) {
      if (i > 0 && x.isNotEmpty) {
        outName += _firstUpperCase(x);
      } else {
        outName += x;
      }
  ...
  String _firstUpperCase(String val) {
